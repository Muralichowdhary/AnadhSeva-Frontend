...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const donationsRes = await axios.get('https://anadhsevabackend-3.onrender.com//admin/donations', {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token")
          }
        });
        const requestsRes = await axios.get('https://anadhsevabackend-3.onrender.com//admin/requests', {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token")
          }
        });
        const usersRes = await axios.get('https://anadhsevabackend-3.onrender.com//admin/users', {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token")
          }
        });
