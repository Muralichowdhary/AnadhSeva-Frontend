...
const Log = () => {
  ...
  const fetchRequests = async () => {
    ...
    switch (type) {
      case "donor":
        endpoint =
          "https://anadhsevabackend-3.onrender.com//api/request/donated";
        break;
      case "receiver":
        endpoint =
          "https://anadhsevabackend-3.onrender.com//api/request/received";
        break;
      case "volunteer":
        endpoint =
          "https://anadhsevabackend-3.onrender.com//api/request/volunteered";
        break;
      default:
        endpoint =
          "https://anadhsevabackend-3.onrender.com//api/request/donated";
  ...
  const updateStatus = async (id) => {
    try {
      const response = await axios.put(
        "https://anadhsevabackend-3.onrender.com//api/request/" + id,
        {
